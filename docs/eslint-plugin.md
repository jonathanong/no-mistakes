...
| `no-banned-import-outside-allowed-paths`          | `{ checkedPathPatterns?: string[], allowedPathPatterns?: string[], bannedImports?: { module: string, names: string[] }[] }`; the reserved name `"default"` bans a module's default export.                                                                     |
