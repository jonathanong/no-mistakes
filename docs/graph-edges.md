...
| `route` | `RouteRef` | `route` | frontend route reference file -> backend route definition file; also Django `path(` / Flask / FastAPI literal decorator handlers inside configured Python packages | [`codebase-intel/packages/web/src/api-client.tsx`](../test-cases/codebase-analysis/codebase-intel/fixture/packages/web/src/api-client.tsx), [`python-celery-django`](../fixtures/lang-frontends/python-celery-django), [`python-flask-fastapi`](../fixtures/lang-frontends/python-flask-fastapi) |
