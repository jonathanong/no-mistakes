...
expect(readRepoFile('package.json')). /* current pin */ toContain('"eslint": "9.0.0"')
expect(readRepoFile('package.json')).toContain(/* current pin */ '"eslint": "9.0.0"')
...
expect('1.2.3'). /* current pin */ toBe(packageJson.dependencies.foo)
expect('1.2.3').toBe((packageJson?.dependencies.foo))
...
expect.poll(async () => packageJson.dependencies.foo).toBe('1.2.3')
...
expect(packageJson.devDependencies).toHaveProperty('eslint', /* current pin */ '10.9.0')
