...
pub(super) const EXPECTED_LANGUAGE_FRONTEND_FILES: usize = 116;
pub(super) const EXPECTED_LANGUAGE_FRONTEND_PARSED: usize = 68;
...
pub(super) const EXPECTED_LANGUAGE_FRONTEND_EDGES: usize = 121;
pub(super) const EXPECTED_LANGUAGE_FRONTEND_QUEUE_EDGES: usize = 14;
pub(super) const EXPECTED_LANGUAGE_FRONTEND_GLOB_MATCHES: usize = 116;
