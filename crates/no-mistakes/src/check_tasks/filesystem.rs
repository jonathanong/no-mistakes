...
const FILESYSTEM_RULE_IDS: &[&str] = &[
    ...
    rules::NO_SPARSE_CHECKOUT,
    rules::NO_TEST_GIT_SHA,
    ...
    rules::POSTGRES_CONFLICT_ORDERING,
    ...
    rules::POSTGRES_REQUIRED_PREDICATES,
    rules::POSTGRES_SQL_SHAPE_POLICY,
    rules::POSTGRES_IDEMPOTENT_INSERT,
