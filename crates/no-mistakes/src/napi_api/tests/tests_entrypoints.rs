...
#[test]
fn dependencies_json_preserves_structured_hash_file_entrypoints_without_symbol() {
    let options = json!({
        "root": fixture_root("symbol-export"),
        "includeSymbols": true,
        "files": [{ "file": "hash#entry.mts" }]
    })
    .to_string();
...
#[test]
fn tests_impact_json_preserves_structured_hash_file_entrypoints_without_symbol() {
    let options = json!({
        "root": fixture_root("tests-impact-symbol"),
        "includeSymbols": true,
        "entrypoints": [{ "file": "hash#utils.mts" }]
    })
    .to_string();
...
#[test]
fn tests_plan_json_preserves_structured_hash_file_entrypoints_without_symbol() {
    let options = json!({
        "root": fixture_root("tests-impact-symbol"),
        "includeSymbols": true,
        "entrypoints": [{ "file": "hash#utils.mts" }]
