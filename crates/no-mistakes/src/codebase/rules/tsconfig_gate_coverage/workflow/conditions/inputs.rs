...
pub(in crate::codebase::rules::tsconfig_gate_coverage::workflow) use event::with_workflow_name;
pub(super) use event::{
    ...
    REF_EXCLUSIONS_KEY, REF_KEY, REF_SHAPE_KEY,
};
...
pub(in crate::codebase::rules::tsconfig_gate_coverage::workflow) use needs::{
    needs_output_value, needs_result_not_skipped, needs_result_value,
};
