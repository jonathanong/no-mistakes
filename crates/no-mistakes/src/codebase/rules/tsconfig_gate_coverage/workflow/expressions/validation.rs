use super::{contexts, lexer, syntax};
...
pub(in super::super) fn complete_expression_contexts_available(
    value: &str,
    allowed: &[&str],
) -> bool {
...
pub(in super::super) fn complete_expression_contexts_with_hash_files_available(
    value: &str,
    allowed: &[&str],
...
pub(in super::super) fn condition_expression_contexts_available(
    value: &str,
    allowed: &[&str],
    hash_files_available: bool,
) -> bool {
...
pub(in super::super) fn interpolated_expression_contexts_available(
    value: &str,
    allowed: &[&str],
) -> bool {
...
pub(in super::super) fn interpolated_expression_contexts_and_hash_files_available(
    value: &str,
    allowed: &[&str],
) -> bool {
...
pub(super) fn interpolated_expression_valid_for_contexts(
    value: &str,
    allowed: Option<&[&str]>,
    hash_files_available: bool,
) -> bool {
...
pub(super) fn interpolated_expression_end(value: &str) -> Option<usize> {
