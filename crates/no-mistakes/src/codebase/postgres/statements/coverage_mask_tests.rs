...
#[test]
fn national_now_epoch_signed_placeholder_and_scoped_overriding() {
    ...
    let combined = "INSERT INTO items (id, seen) VALUES (1, 'a');\nINSERT INTO items (id, seen) OVERRIDING USER VALUE VALUES (2, 'b');";
