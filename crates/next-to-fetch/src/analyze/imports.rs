...
use crate::analyze::resolve::resolve_import;
use anyhow::Result;
...
#[derive(Default)]
pub(crate) struct IdentifierReferenceCollector {
...
pub(crate) fn collect_runtime_imports_from_program<'a>(
    abs_path: &Path,
