...
pub(crate) fn cache_wrapper_name(expr: &CallExpression<'_>) -> Option<(String, CacheKind)> {
...
pub(crate) fn extract_fetch_cache_options(
...
pub(crate) fn infer_cached_wrapper_name(source: &str, expr: &CallExpression<'_>) -> Option<String> {
